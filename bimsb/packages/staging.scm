...
(define-public jellyfish-for-sailfish
  (package (inherit jellyfish)
    ...
    (source (origin
              ...
              (sha256
               (base32
                "07nkwx2fms7fd0blf71lpr0zlnmknmkm4g4iz63xwpvdz8akyf75"))))
    (build-system gnu-build-system)
    ...
    (arguments
     `(#:configure-flags
       ...
       (modify-phases %standard-phases
         ...
         ;; (add-after 'install 'check
         ;;   (assoc-ref %standard-phases 'check))
         ;; And the location of the test data file must be overridden.
         (add-after 'unpack 'fix-tests
           (lambda _
             (substitute* "cmake/SimpleTest.cmake"
               (("sample_data.tgz")
                (string-append (getcwd) "/sample_data.tgz")))
             #t)))))
    (inputs
     `(("boost" ,boost)
       ("eigen" ,eigen)
...
assembly) to quantify.  All you need to run sailfish is a fasta file
